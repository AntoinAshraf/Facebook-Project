...
namespace Facebook.Controllers
{
    public class AccountController : Controller
    {
        ...
        public IActionResult Register([FromBody]UserRegisterDTO userRegisterDto)
        {
            ...
            email.SendAccountActivationEmail(user.Email, "https://facebookiti.azurewebsites.net/Account/ActivateAccount/?token=" + token);
        ...
        public ActionResult SendForgetPasswordCode([FromQuery]string Email)
        {
            ...
            userData.SetUser(HttpContext, user);
            string token = jwt.GenerateToken(user.Id);
            email.SendRecoveryPasswordEmail(user.Email, code, "https://facebookiti.azurewebsites.net/Account/RecoverPassword/?token=" + token);
            return Json(new { statusCode = ResponseStatus.Success });
        }
